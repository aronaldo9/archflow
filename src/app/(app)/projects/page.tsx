    ...
    <div className="max-w-7xl space-y-6">
      ...
      {filtered.length === 0 ? (
        <div className="text-center py-16">
          <svg aria-hidden="true" className="w-10 h-10 text-zinc-700 mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            return (
              <li key={project.id}>
                <Link
                  ...
                  className="block bg-zinc-800/50 border border-zinc-700/50 rounded-xl p-6 hover:border-zinc-600 transition-all group"
                >
                  <div className="flex flex-col lg:flex-row lg:items-center gap-4">
                    ...
                    <div className="flex flex-row lg:flex-col gap-6 lg:gap-4 lg:items-end lg:min-w-[280px]">
                      <dl className="flex gap-6">
                        <div>
                          <dt className="text-zinc-500 text-xs mb-0.5">Presupuesto</dt>
                          <dd className="text-white text-sm font-medium">{formatCurrency(project.budget)}</dd>
                        </div>
                        <div>
                          <dt className="text-zinc-500 text-xs mb-0.5">Gastado</dt>
                          <dd className="text-white text-sm font-medium">{formatCurrency(project.spent)}</dd>
                        </div>
                        <div>
                          <dt className="text-zinc-500 text-xs mb-0.5">Fecha límite</dt>
